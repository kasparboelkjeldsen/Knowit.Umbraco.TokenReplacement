...
export default function publish() {
    ...
    const solutionPath = join(rootDir, 'Knowit.Umbraco.TokenReplacement.sln');
    const projectPath = join(rootDir, 'Knowit.Umbraco.TokenReplacement.Backend');
    const csprojectPath = join(projectPath, 'Knowit.Umbraco.TokenReplacement.Backend.csproj');
