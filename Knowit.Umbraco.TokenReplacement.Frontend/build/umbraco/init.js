...
export default function initUmbraco(args) {
    ...
    const solutionFilePath = join(rootDir, 'Knowit.Umbraco.TokenReplacement.sln');
    ...
    try {
        ...
        execSync(`dotnet add "${join(projectDir, projectName + '.csproj')}" reference "${join(rootDir, 'Knowit.Umbraco.TokenReplacement.Backend', 'Knowit.Umbraco.TokenReplacement.Backend.csproj')}"`, { stdio: 'inherit' });
